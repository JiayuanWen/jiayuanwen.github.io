(function() {
    ...
    if (!n)
        if (document.querySelectorAll("script[type=module-shim],script[type=importmap-shim],link[rel=modulepreload-shim]").length) n = true;
        else {
            let e = false;
    ...
    function resolveIfNotPlainOrUrl(e, t) {
        const r = t.indexOf("#"),
            s = t.indexOf("?");
        r + s > -2 && (t = t.slice(0, -1 === r ? s : -1 === s || s > r ? r : s)); - 1 !== e.indexOf("\\") && (e = e.replace(ve, "/"));
    ...
    function parse(e, t = "@") {
        ...
        if (r > Te || !Me) {
            for (; r > Te;) Te *= 2;
            je = new ArrayBuffer(Te), _e(Ne, new Uint16Array(je, 16, 105)), Me = function(e, t, r) {
                "use asm";
                                                ...
                                                default: {
                                                    ...
                                                    r: do {
                                                        if (!(U(i) | 0)) {
                                                            ...
                                                            t = a[68] | 0;
                                                            r = c[396] | 0;
                                                            if (!(p(a[t + (r << 3) + 4 >> 2] | 0) | 0) ? (a[t + (r << 3) >> 2] | 0) != 6 : 0) ne = 66;
                                                            else ne = 69
                                                        } else switch (i << 16 >> 16) {
                                                            case 46:
                ...
                function l() {
                    ...
                    e: do {
                        if ((de | 0) == 3) {
                            ...
                            } while (0);pe = (w(1) | 0) << 16 >> 16 == 102;e = a[70] | 0;
                    ...
                    do {
                        if ((s | 0) == 5) {
                            ...
                            if (e) {
                                ...
                                r = a[70] | 0;
                                if (!(((t << 16 >> 16 == 119 ? (n[r + 2 >> 1] | 0) == 105 : 0) ? (n[r + 4 >> 1] | 0) == 116 : 0) ? (n[r + 6 >> 1] | 0) == 104 : 0)) s = 11
                            }
                            if ((s | 0) == 11) {
                                a[70] = r + -2;
                                break
                ...
                function o(e) {
                    ...
                    e: do {
                        switch (n[e >> 1] | 0) {
                            ...
                            case 102: {
                                if ((n[e + -2 >> 1] | 0) == 111 ? (n[e + -4 >> 1] | 0) == 101 : 0) switch (n[e + -6 >> 1] | 0) {
                                    case 99: {
                                        e = O(e + -8 | 0, 118, 6) | 0;
                                        break e
                                    }
                ...
                function j(e) {
                    ...
                    switch (n[e >> 1] | 0) {
                        ...
                        case 101: {
                            if ((n[e + -2 >> 1] | 0) == 117) e = O(e + -4 | 0, 106, 6) | 0;
                            else e = 0;
                            break
                        }
                        default:
            ...
            }("undefined" != typeof self ? self : global, {}, je), Re = Me.su(Te - (2 << 17))
        }
        const s = He.length + 1;
        Me.ses(Re), Me.sa(s - 1), _e(He, new Uint16Array(je, Re, s)), Me.p() || (Fe = Me.e(), o());
        const n = [],
            a = [];
        for (; Me.ri();) {
            const e = Me.is(),
                ...
                i = Me.se();
            let c;
            Me.ip() && (c = b(-1 === s ? e : e + 1, He.charCodeAt(-1 === s ? e - 1 : e))), n.push({
                n: c,
                s: e,
                e: t,
                ss: a,
                    ...
                    for (const t of e)
                        if ("childList" === t.type)
                            for (const e of t.addedNodes)
                                ...
                                } else "LINK" === e.tagName && e.rel === (n ? "modulepreload-shim" : "modulepreload") && processPreload(e)
                })).observe(document, {
                    childList: true,
                    subtree: true
                });
    ...
    function resolveDeps(e, t) {
        ...
        for (const {
            ...
            if (-1 === ce) {
                let r = e.d[c++],
                    s = r.b,
                    f = !s;
                f && ((s = r.s) || (s = r.s = createBlob(`export function u$_(m){${r.a[1].map((({s:e,e:t},s)=>{const n='"'===r.S[e]||"'"===r.S[e];return`
                    e$_$ {
                        s
                    } = m$ {
                        n ? "[" : "."
        ...
        oe < i && (oe = -1);
        ce < i && (ce = -1); - 1 !== oe && (-1 === ce || ce > oe) && pushSourceURL(Qe, oe);
        if (-1 !== ce) {
            pushSourceURL(Xe, ce); - 1 !== oe && oe > ce && pushSourceURL(Qe, oe)
        }
        pushStringTo(n.length); - 1 === oe && (a += Qe + e.r);
        e.b = Ze = createBlob(a);
        e.S = void 0
    }
    const Qe = "\n//# sourceURL=";
    ...
    function pushFetchPool() {
        if (++at > 100) return new Promise((e => nt.push(e)))
    }
    ...
    async function doFetch(e, t, r) {
        if (de && !t.integrity) throw Error(`No integrity for ${e}${fromParent(r)}.`);
        ...
        if (!n.ok) throw Error(`${n.status} ${n.statusText} ${n.url}${fromParent(r)}`);
        return n
    }
    ...
    function getOrCreateLoad(e, t, r, s) {
        ...
        a.f = (async () => {
            if (!s) {
                ...
                ({
                    ...
                    s: s,
                    t: i
                } = await (lt[e] || fetchModule(e, t, r)));
                if (i && !n) {
                    if ("css" === i && !me || "json" === i && !he) throw Error(`${i}-modules require <script type="esms-options">{ "polyfillEnable": ["${i}-modules"] }<\/script>`);
        ...
        a.L = a.f.then((async () => {
            let e = t;
            a.d = (await Promise.all(a.a[0].map((async ({
                n: t,
                d: r
            }) => {
    ...
    function processScriptsAndPreloads(e = false) {
        if (!e)
            for (const e of document.querySelectorAll(n ? "link[rel=modulepreload-shim]" : "link[rel=modulepreload]")) processPreload(e);
        for (const e of document.querySelectorAll(n ? "script[type=importmap-shim]" : "script[type=importmap]")) processImportMap(e);
        if (!e)
            for (const e of document.querySelectorAll(n ? "script[type=module-shim]" : "script[type=module]")) processScript(e)
    }
