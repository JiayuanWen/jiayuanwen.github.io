...
// By Álvaro (https://codepen.io/alvarotrigo) from CodePen
// Source code: https://codepen.io/alvarotrigo/pen/bGLpROa
function CalendarControl() {
    ...
    const calendarControl = {
      ...
      dayPostfix: function () {
        let d = Number(calendarControl.localDate.getDate());
        if ((d % 10) == 1) {
            return "st";
        }
        if ((d % 10) == 2) {
      ...
      plotSelectors: function () {
        document.querySelector(
          ...
          <!--<div style="font-weight: 500; font-size: 20px;">&nbsp;${calendarControl.localDate.getDate()}${calendarControl.dayPostfix()}</div>-->
          <div style="font-weight: 500; font-size: 20px;">,&nbsp;</div>
          <div class="calendar-year-label"></div>
          <hr class="calender-sep"/>
          </div>
